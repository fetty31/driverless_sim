...
def node():
    ...
    # Define publisher
    pub = rospy.Publisher(rospy.get_param("/Tracker/Topics/Input/Track"), MarkerArray, queue_size=10)
    sub = rospy.Subscriber(rospy.get_param("/Tracker/Topics/Output/Moved"), Float32MultiArray, callback)
